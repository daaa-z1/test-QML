        ...
        Repeater {
            ...
            Rectangle {
                ...
                CircleGauge {
                    ...
                    minScale: mainApp ? mainApp.minScale[index] : 0
                    maxScale: mainApp ? mainApp.maxScale[index] : 0
                    minValue: mainApp ? mainApp.minValue[index] : 0
                    maxValue: mainApp ? mainApp.maxValue[index] : 0
